...
const Home = () => {
	return (
		<section>
			...
			<section
				class="overflow-hidden bg-[url(https://images.pexels.com/photos/259588/pexels-photo-259588.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)] bg-cover bg-center bg-top bg-no-repeat"
			>
				<div class="bg-black/25 p-8 md:p-12 lg:px-16 lg:py-24">
					<div class="text-center ltr:sm:text-left rtl:sm:text-right">
						<h2 class="text-2xl font-bold text-white sm:text-3xl md:text-8xl">
							TurnKey
						</h2>

						<p
							class="hidden max-w-lg m-auto text-white/90 md:mt-6 md:block md:text-lg md:leading-relaxed"
						>
							Find your new home today.
						</p>

						<div class="mt-4 sm:mt-8">
							{/* list all search filters here. */}
						</div>
					</div>
				</div>
			</section>

			<div class="grid grid-cols-3 p-4 mt-2 mb-8">
				<div class="block group p-4 shadow rounded-xl">
					...
					<div class="mt-3">
						<h3
							class="text-sm text-gray-700 group-hover:underline group-hover:underline-offset-4 text-left"
						>
							Townhome Available
						</h3>
